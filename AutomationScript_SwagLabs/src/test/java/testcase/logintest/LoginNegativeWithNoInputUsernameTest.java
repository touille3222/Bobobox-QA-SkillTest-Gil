...
public class LoginNegativeWithNoInputUsernameTest {
    WebDriver driver;
    ...
    public void loginTest(){
        ...
        //Element action
        loginPage.inputUsername(""); //diisi dengan username kosong
        ...
        Assert.assertEquals(loginPage.errorGetText(),"Epic sadface: Username is required");
    }
