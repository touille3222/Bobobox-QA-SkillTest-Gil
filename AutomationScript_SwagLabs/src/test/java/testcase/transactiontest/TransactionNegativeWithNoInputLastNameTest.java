...
//TEST CASE ID: TC_Transaction_010
public class TransactionNegativeWithNoInputLastNameTest {
    WebDriver driver;
    ...
    public void transactionTest(){
        ...
        checkoutPage.inputLastNameField("");
        ...
        Assert.assertEquals(checkoutPage.getErrorFieldWarningText(),"Error: Last Name is required");
    }
